    ...
    return (
        ...
        <div id="slide1" className="carousel-item relative w-full ">
          ...
          <div className="absolute pl-11 top-9   ">
            <div className="text-red-400  mt-11  text-3xl font-extrabold">
            Affordable<br></br> Price For Car<br></br> Servicing
            </div>
            <p className="text-red-400 mt-5 text-md mb-7 font-semibold" >There are many variations of passages of  available,<br></br>
                 but the majority have suffered alteration in some form</p>
            <div className="flex gap-5 ">
            <button className="btn btn-error text-white">Discover More</button>
            <button className="btn btn-error text-white">Latest Project</button>
            </div>
          
          </div>
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-1  ">
            <a href="#slide4" className="btn btn-circle bg-red-600 text-white mr-4">❮</a> 
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-1  ">
            <a href="#slide1" className="btn btn-circle  bg-red-600 text-white  mr-4">❮</a> 
        ...
        <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-1  ">
            <a href="#slide2" className="btn btn-circle  bg-red-600 text-white  mr-4">❮</a> 
        ...
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-1  ">
            <a href="#slide3" className="btn btn-circle  bg-red-600 text-white  mr-4">❮</a> 
